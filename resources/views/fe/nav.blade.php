        ...
        <div class="container header__container">
            <div class="header__main">
                <a href="index.html" class="logo">
                    <img height="60" width="300" src="https://konvergenz.co.ke/wp-content/uploads/2021/11/Konvergenz-Official-Logo.png" alt="logo">
                </a>
                <div class="main-menu">
                    <nav>
                        <ul>
                            ...
                            <li>
                                ...
                                <ul class="sub-menu">
                                    <li>
                                        <a href="service-solutions.html">Enterprice, Network and Security</a>
                                    </li>
                                    <li>
                                        <a href="service.html">Data Center, Digital Power Systems & Connectivity</a>
                                    </li>
                                    <li>
                                        <a href="service-details.html">Telecommunication</a>
                                    </li>
                                    <li>
                                        <a href="service-details.html">Enterprice Application & Analytics</a>
                                    </li>
                                    <li>
                                        <a href="service-details.html">Cybersecurity</a>
                                    </li>
                                    <li>
                                        <a href="service-details.html">Compute and Business Resiliency</a>
                                    </li>
                                </ul>
                            </li>
                            <li class="has-megamenu">
                            ...
                            <li><a href="">Resources and insights</a></li>
                            <!-- <li>
                                <a href="#0">Blog</a>
                                <ul class="sub-menu">
                                    <li>
                ...
                <div class="d-none d-xl-flex gap-4">
                    ...
                    <div class="about-three__left-item d-flex flex-wrap gap-2 align-items-center">
                        ...
                        <div class="info">
                            ...
                            <h5 class="text-white">+254-709-208000</h5>
                        </div>
                    </div>
                </div>
