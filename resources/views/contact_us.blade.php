                    ...
                    <div class="col-lg-6">
                        <div class="contact__right-item">
                            <div class="section-header mb-20">
                                ...
                                <h2 class="wow fadeInUp" data-wow-delay="200ms" data-wow-duration="1500ms" style="visibility: visible; animation-duration: 1500ms; animation-delay: 200ms; animation-name: fadeInUp;">Ready to Get
                                    Started?</h2>
                                ...
                                <form action="#">
                                    <div class="row">
                                        <div class="col-6">
                                            ...
                                            <input id="name" class="bg-transparent bor" type="text" placeholder="Your First Name">
                                        </div>
                                        <div class="col-6">
                                            <label for="name">Your Last Name*</label>
                                            <input id="name" class="bg-transparent bor" type="text" placeholder="Your Last Name">
                                        </div>
                                        <div class="col-12">
                                            <label for="email">Your Email*</label>
                                            <input class="bg-transparent bor" id="email" type="email" placeholder="Your Email">
                                        </div>
                                    </div>
                                    <div class="text-area">
                                    ...
                                    <div class="btn-two">
                                        ...
                                        <a href="#" class="btn-one">Send Message <i class="fa-regular fa-arrow-right-long"></i></a>
                                    </div>
                                </form>
                            </div>
                        </div>
